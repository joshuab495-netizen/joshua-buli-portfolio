...
import { AUTOMATION_HIGHLIGHTS } from '../data/automation'
  ...
  return (
    <section className="py-20 md:py-24">
      <div className="max-w-container mx-auto px-6">
        <Reveal>
          <p className="text-sm font-semibold uppercase tracking-wider text-accent">Automation &amp; Reporting</p>
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-navy">Cutting Manual Work Across Branches</h2>
        </Reveal>
        ...
        >
          {AUTOMATION_HIGHLIGHTS.map(({ Icon, title, description }) => (
            <motion.div
              key={title}
